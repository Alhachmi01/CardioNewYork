...
const description = "Free practical tools for travel, calculations and everyday planning.";

export const metadata: Metadata = {
  title: "Tools",
  description,
  alternates: { canonical: "/tools" },
  openGraph: { title: "GuideVexa Tools", description, url: "/tools", type: "website" },
};
